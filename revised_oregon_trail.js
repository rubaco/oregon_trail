...
console.log("initial food:" + this.traveler.food);  // FIXME: Remember: you'll want to be checking the `food` property of the particular traveler,
...
console.log(this.foodIncrease)
  this.traveler.food = this.traveler.food * 2; // NOTE: This would throw an error "Traver is not defined". Just a simple misspelling. But as above, you won't actually want to be checking the Traveler class object's food property.
}
  else {

    this.traveler.food = this.traveler.food * 1.5;
  }

  console.log("final food is " + this.traveler.food);
...
//Consumes 20 of the traveler's food. If the traveler doesn't have 20 food, the traveler is no longer healthy.
    eat= function(traveler){ // FIXME: Same issue as with `hunt()`
  ...
  traveler= new Traveler();
    ...
    console.log ("traveler:" + traveler.name + "was pushed to: "  + wagon.name + "and the new capacity of wagon is at: " + wagon.capacity)
